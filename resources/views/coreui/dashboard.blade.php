                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-sm-7 d-none d-md-block">
                                ...
                                <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-secondary active">
                                        <input id="option2" name="options" autocomplete="off" checked="" type="radio">
                                        Month
                                    </label>
                                    <label class="btn btn-outline-secondary">
                        ...
                        <div class="chart-wrapper" style="height:300px;margin-top:40px;">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="main-chart" height="300" style="display: block;"
                                width="1601"></canvas>
                        </div>
                    </div>
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-facebook">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-1" height="96" style="display: block; width: 386px; height: 96px;"
                                        width="386" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-twitter">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-2" height="96" style="display: block; width: 386px; height: 96px;"
                                        width="386" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-linkedin">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-3" height="96" style="display: block; width: 386px; height: 96px;"
                                        width="386" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-google-plus">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-4" height="96" style="display: block; width: 386px; height: 96px;"
                                        width="386" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
