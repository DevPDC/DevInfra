<header class="app-header navbar" id="navbar-map">
  <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
    <span class="navbar-toggler-icon"></span>
  </button>
  <a class="navbar-brand" href="#">
    <img class="navbar-brand-full" src="{{ asset('public/storage/logo/philrice-black.png') }}" width="100" height="30"
      alt="PhilRice Logo">
    <img class="navbar-brand-minimized" src="https://coreui.io/demo/dark/img/brand/sygnet.svg" width="30" height="30"
      alt="CoreUI Logo">
  </a>
  ...
  <ul class="nav navbar-nav d-md-down-none">
    <li class="nav-item px-3">
      <a class="nav-link text-white" href="{{route('posts.index')}}">Service Requests</a>
    </li>
    <li class="nav-item px-3">
  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <img class="img-avatar" src="img/avatars/6.jpg" alt="{{ App\Profile::select('emp_fullname')->where('emp_idno', Auth::user()->user_idno)->first()->emp_fullname }}">
      </a>
